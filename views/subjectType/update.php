...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Sửa loại môn học</h1>
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Sửa loại môn học</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sửa <?php echo $subjectType->subjectTypeName; ?></h3>
                        </div>
                        <div class="container-fluid">
                            <div class="row">
                                <form class='form__container col-6'
                                    action='/final-php/subjectType?act=update&id=<?php echo $subjectType->id; ?>'
                                    method='post'>
                                    <div class="card-body">
